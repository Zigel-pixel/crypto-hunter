...
WALLET_BALANCE_CACHE_SECONDS = _get_positive_int("WALLET_BALANCE_CACHE_SECONDS", 60)
WALLET_MAX_PER_USER = _get_positive_int("WALLET_MAX_PER_USER", 10)
LIVE_CHART_REFRESH_SECONDS = _get_positive_int("LIVE_CHART_REFRESH_SECONDS", 45)
